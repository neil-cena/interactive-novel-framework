  ...
  <div class="mt-6 flex flex-col gap-3" role="list" aria-label="Story choices">
    <TransitionGroup name="choice-list" tag="div" class="choice-list flex flex-col gap-3">
      <button
        ...
        :key="choice.id"
        type="button"
        class="choice-list-item rounded-md border border-slate-500/70 bg-slate-800 px-4 py-3 text-left text-slate-100 transition hover:border-slate-300 hover:bg-slate-700"
        role="listitem"
